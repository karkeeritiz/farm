    ...
    <div class="thumbnail" style="width: 65%; margin:auto;">
        ...
        <form method="POST" enctype="multipart/form-data" style="width:70%; margin: auto;">
            ...
            <div name="select-cat" style="padding-right: 50px; color: #808080;">
                <input name="category"
                       type="radio" <?php if (isset($category) && $category == "buyer") echo "checked"; ?>
                       value="buyer">Buyer
                <input name="category"
                       type="radio" <?php if (isset($category) && $category == "farmer") echo "checked"; ?>
                       value="farmer">Farmer
            </div>


            <div class="form-group" style="position:relative;">
                <input type="text" style="padding-left: 25px;" class="form-control" minlength="8"
                       placeholder="Username or Company Name " id="UserName" name="username"/>
                <i class="fa fa-user" style="position: absolute; left: 0; top:2px; padding: 9px 8px; color: #aaa"></i>
            </div>
            <div class="form-group" style="position:relative;">
                <input type="email" style="padding-left: 25px;" class="form-control" placeholder="Email " id="Email"
                       name="email">
                <i class="fa fa-envelope"
                   style="position: absolute; left: 0; top:2px; padding: 9px 8px; color: #aaa"></i>
            </div>
            <div class="form-group log-status" style="position:relative;">
                <input type="password" style="padding-left: 25px;" class="form-control" class="form-control"
                       placeholder="Password" minlength="8" id="Passwod" name="password">
                <i class="fa fa-lock" style="position: absolute; left: 0; top:2px; padding: 9px 8px; color: #aaa"></i>
            </div>
            <div class="form-group log-status" style="position:relative;">
                <input type="password" style="padding-left: 25px;" class="form-control" class="form-control"
                       placeholder="Confrim Password" minlength="8" id="Passwod" name="confirmpassword">
                <i class="fa fa-lock" style="position: absolute; left: 0; top:2px; padding: 9px 8px; color: #aaa"></i>
            </div>


            <div align="center">
                <button align="center" ; style="width: 50%; margin-bottom: 50px;" name="signUpbtn" type="submit"
                        class="btn btn-primary"><strong>Register</strong></button>
            </div>
