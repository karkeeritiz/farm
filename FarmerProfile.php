    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="font-weight: bold;">
            <ul class="nav navbar-nav">
                <li>
                    <a id="productsbtn" style="padding-right: 100px;"
                       href="FarmerProfile.php?username=<?php if (isset($_SESSION['Company_Name'])) echo $_SESSION['Company_Name']; ?>">View
                        My Products</a>
                </li>
                <li>
                ...
                <li>
                    <a id="orderbtn" style="padding-right: 100px;"
                       href="addProduct.php?username=<?php if (isset($_SESSION['Company_Name'])) echo $_SESSION['Company_Name']; ?>">Add
                        New Product</a>
                </li>
...
<div class="container">
    <header class="jumbotron hero-spacer"
        ...
        <h1 align="center" style="color:white;">
            <strong> <?php if (isset($_SESSION['Company_Name'])) echo $_SESSION['Company_Name']; ?></strong></h1>
    </header>
            ...
            <div class="table-responsive" id="productsdiv" style="padding-left: 50px;">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a style="padding: 5px;" href="editProduct.php?edit=<?php echo $row["id"] ?>"><span
                                        class="text-danger"><strong>Edit</strong></span></a><br/>
                            <button name="delete" class="btn"><span class="text-danger"><strong>Delete</strong></span>
                            </button>
                        </td>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <?php if ($row["status"] == "Not Delivered") {
                                    ?>
                                    <td><input type="text" class="status" value="Not Delivered"
                                               style="color: red; border: 0px; font-weight: bold;" readonly/>
                                    </td>
                                    <?php
                                } else {
                                    ?>
                                    <td><input type="text" class="status" value="Confirmed Delivery"
                                               style="color: red; border: 0px; font-weight: bold; " readonly/>
                                    </td>
