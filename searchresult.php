...
<div class="container">
    ...
    if (isset($_POST["search"])) {
        $valuetosearch = mysqli_real_escape_string(trim($_POST["searchvalue"]));

        $sql = mysqli_query("SELECT * FROM `products` WHERE `Description` LIKE '%$valuetosearch%' OR `type_product` LIKE '%$valuetosearch%' ");
