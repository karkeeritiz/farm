...
<h3 align="center">You are logged in
    as <?php if (isset($_SESSION['Company_Name'])) echo $_SESSION['Company_Name']; ?></h3>
</br>
</br>
<form method="post" enctype="multipart/form-data" action="" style="width:50%; margin: auto;">
    ...
    <div class="form-group ">
        <input type="text" class="form-control" placeholder="Company Name " id="username" minlength="8" name="username"
               value="<?php echo $row["CompanyName"]; ?>">
        <i class="fa fa-user"></i>
    </div>
    <div class="form-group ">
        <input type="number" class="form-control" placeholder="Phone Number " id="Phone" minlength="8" name="phone"
    ...
    <div class="form-group ">
        <input type="text" class="form-control" minlength="4"
               placeholder="Kind of Product e.g Rice, yam, palm oil e.t.c" id="category" name="category"
               value="<?php echo $row["Category"]; ?>">
        <i class="fa fa-user"></i>
    </div>
    <div class="form-group ">
        <input type="number" class="form-control" minlength="6" placeholder="Enter Price of Product" id="price"
               name="price" value="<?php echo $row["Prcie"]; ?>">
        <i class="fa fa-user"></i>
    </div>

    <div class="form-group ">
        <textarea class="form-control" minlength="20" maxlength="120" placeholder="Description " id="description"
                  name="description" style="width:100%;height:150px;"><?php echo $row["Description"]; ?></textarea>
        <i class="fa fa-user"></i>
    </div>
    <div class="form-group ">
        ...
        <form method="post" enctype="multipart/form-data" style="width:50%; margin: auto;">
            ...
            <button name="imageUpdate" type="file" class="btn" style="float: left;"><strong>Update Image</strong>
            </button>
            <br/>

            <p>
                <br/>
                <button name="AddProduct" type="submit" class="btn btn-primary" style="float: right;"><strong>UPDATE
                        PRODUCT</strong></button>
            </p>
        </form>
